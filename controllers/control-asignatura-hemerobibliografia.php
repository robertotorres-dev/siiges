<?php
  /**
  * Archivo que gestiona los web services de la clase AsignaturaHemerobibliografia
  */

  require_once "../models/modelo-asignatura-hemerobibliografia.php";
  ...
  {
    $obj = new AsignaturaHemerobibliografia( );
