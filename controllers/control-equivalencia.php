...
if ($_POST["webService"] == "guardar") {
  ...
  if (!isset($_POST["estatus_certificado"])) {
    $_POST["estatus_certificado"] = -1;
  }
  if (!isset($_POST["estatus_nacimiento"])) {
    $_POST["estatus_nacimiento"] = -1;
  }
  if (!isset($_POST["estatus_curp"])) {
  ...
  if ($_FILES["archivo_certificado"]["name"] != null) {
    $parametrosAlumno["archivo_certificado"] = "documento1_" . $_POST["alumno_id"] . ".pdf";
  }
  if ($_FILES["archivo_nacimiento"]["name"] != null) {
    $parametrosAlumno["archivo_nacimiento"] = "documento2_" . $_POST["alumno_id"] . ".pdf";
  }
  if ($_FILES["archivo_curp"]["name"] != null) {
    $parametrosAlumno["archivo_curp"] = "documento3_" . $_POST["alumno_id"] . ".pdf";
  }
  ...
  if ($_FILES) {
    if ($_FILES["archivo_certificado_parcial"]["name"] != null) {
      $parametros["archivo_certificado_parcial"] = "archivo_certificado_parcial_" . $_POST["alumno_id"] . ".pdf";
    }
    if ($_FILES["archivo_resolucion"]["name"] != null) {
      $parametros["archivo_resolucion"] = "archivo_resolucion_" . $_POST["alumno_id"] . ".pdf";
    }
  }
