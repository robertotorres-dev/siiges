...
if ($_POST["webService"] == "consultarTodos") {
  ...
  /* $bitacora = new Bitacora();
    ...
    $bitacora->setAttributes(["usuario_id"=>$usuarioId,"entidad"=>"estados","accion"=>"consultarTodos","lugar"=>"control-estado"]);
...
if ($_POST["webService"] == "consultarId") {
  ...
  /* $bitacora = new Bitacora();
    $usuarioId= isset($_SESSION["id"])?$_SESSION["id"]:-1;
    $bitacora->setAttributes(["usuario_id"=>$usuarioId,"entidad"=>"estados","accion"=>"consultarId","lugar"=>"control-estado"]);
    $result = $bitacora->guardar(); */
  retornarWebService($_POST["url"], $resultado);
}
...
if ($_POST["webService"] == "guardar") {
  ...
  /* $bitacora = new Bitacora();
    $usuarioId= isset($_SESSION["id"])?$_SESSION["id"]:-1;
    $bitacora->setAttributes(["usuario_id"=>$usuarioId,"entidad"=>"estados","accion"=>"guardar","lugar"=>"control-estado"]);
    $result = $bitacora->guardar(); */
  retornarWebService($_POST["url"], $resultado);
}
...
if ($_POST["webService"] == "eliminar") {
  ...
  /* $bitacora = new Bitacora();
    $usuarioId= isset($_SESSION["id"])?$_SESSION["id"]:-1;
    $bitacora->setAttributes(["usuario_id"=>$usuarioId,"entidad"=>"estados","accion"=>"eliminar","lugar"=>"control-estado"]);
    $result = $bitacora->guardar(); */
  retornarWebService($_POST["url"], $resultado);
}
