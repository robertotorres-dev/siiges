...
/**
 * Archivo que gestiona los web services de la clase SaludInstitucion
 */
...
if ($_POST["webService"] == "consultarTodos") {
  $obj = new SaludInstitucion();
  $obj->setAttributes(array());
  $resultado = $obj->consultarTodos();
  // Registro en bitacora
  /* $bitacora = new Bitacora();
      $usuarioId= isset($_SESSION["id"])?$_SESSION["id"]:-1;
      $bitacora->setAttributes(["usuario_id"=>$usuarioId,"entidad"=>"salud_instituciones","accion"=>"consultarTodos","lugar"=>"control-salud-institucion"]);
