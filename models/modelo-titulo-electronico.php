...
class TitulosElectronicos extends Catalogo
{
  ...
  public function consultarTitulosInstitucion()
  {
    $sql = "select * from " . TABLA_TITULOS_ELECTRONICOS . " where institucion_id='$this->institucion_id' and deleted_at is null order by id";
