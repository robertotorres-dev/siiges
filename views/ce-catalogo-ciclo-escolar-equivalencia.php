		...
		<section class="main row margin-section-formularios">
			...
			<div class="row" style="padding-left: 15px; padding-right: 15px;">
				<div class="col-sm-12 col-md-12 col-lg-12">
					...
					<ol class="breadcrumb pull-left">
						...
						<li><a href="ce-programas-plantel-equivalencia.php">Programas de Estudios</a></li>
          ...
          <div class="col-sm-12">
            <div class="form-group">
							...
							<input type="hidden"  name="url" value="../views/ce-ciclos-escolares-equivalencia.php?programa_id=<?php echo $_GET["programa_id"]; ?>&codigo=200" />
						</div>
          </div>
        </div>
				<?php
