              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href=<?= "../uploads/Institucion" . $res_institucion["data"]["id"] . "/titulacion_electronica/constancia_titulo_" . $resultadoTitulo["data"][$i]["folio_control"] . ".xml" ?> download=<?= "constancia_titulo_" . $resultadoTitulo["data"][$i]["folio_control"] . ".xml" ?>><span id="" title="Descargar XML" class="glyphicon glyphicon-list-alt col-sm-1 size_icon"></span></a>
                  </td>
                </tr>
              <?php
              }
