...
$plantel = new Plantel();
$plantel->setAttributes(array("id" => $_GET["plantel_id"]));
        ...
        <div class="col-sm-12 col-md-12 col-lg-12">
          ...
          <ol class="breadcrumb pull-left">
            ...
            <?php if (Rol::ROL_CONTROL_ESCOLAR_SICYT == $_SESSION["rol_id"] || Rol::ROL_ADMIN == $_SESSION["rol_id"]) : ?>
              <li><a href="ce-planteles.php<?php echo "?institucion_id=" . $resultadoInstitucion["data"]["id"] ?>">Planteles</a></li>
            <?php endif; ?>
