...
require_once ".. /utilidades/utileria-general.php";
...
<cabeza>
	...
	<!-- CSS GOB. MX -->
	<enlace href=".. /favicon.ico" rel="icono de acceso directo">
...
<Clase de cuerpo ="">
	...
	<!-- Modal Oficio - >
	<div id="modalOficio" class="fundido modal">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times; </botón>
	...
	<div id="modalActaDeCierre" class="fundido modal">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times; </botón>
	...
	<div id="modalActaDeInspeccion" class="fundido modal">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times; </botón>
	...
	<div id="modalAcuerdoCambioRepresentante" class="fundido modal">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times; </botón>
