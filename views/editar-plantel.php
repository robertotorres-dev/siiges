						...
						<div class="form-group">
							...
							<div class="col-sm-6 col-md-8">
								...
								<div class="form-group col-sm-12 col-md-12">
									...
									<br>
									<input type="email" id="email3" name="email3" class="form-control" value="" placeholder="correo@dominio.com">
									<br>
								</div>
								<div class="form-group col-sm-12 col-md-12">
									<label class="control-label" for="">Teléfono(s):</label><br>
									<div class="form-group col-sm-6 col-md-4">
										<input type="tel" id="telefono1" name="telefono1" class="form-control" value="" placeholder="33-45-58-25-54">
										<br>
									</div>
									<div class="form-group col-sm-6 col-md-4">
										<input type="tel" id="telefono2" name="telefono2" class="form-control" value="" placeholder="33-45-58-25-54">
										<br>
									</div>
									<div class="form-group col-sm-6 col-md-4">
										<input type="tel" id="telefono3" name="telefono3" class="form-control" value="" placeholder="33-45-58-25-54">
										<br>
									</div>
								</div>
								<div class="form-group col-sm-12 col-md-12">
									<label class="control-label" for="">Redes sociales:</label><br>
									<textarea class="form-control" id="redes_sociales" name="redes_sociales" rows="8" cols="20" placeholder="Facebook:&#10;Twitter:&#10;Instagram:"></textarea>
								</div>
								<div class="form-group col-sm-12 col-md-12">
									<label class="control-label" for="">Página web:</label><br>
									<input type="url" id="paginaweb" name="paginaweb" class="form-control" value="" placeholder="www.universidad.com">
								</div>
								...
								<div class="form-group col-sm-12 col-md-12">
									...
									<input type="text" id="nombre_rector" name="nombre_rector" class="form-control" value="" placeholder="Nombre del rector" required><br>
									<input type="text" id="apellido_paterno_rector" name="apellido_paterno_rector" class="form-control" value="" placeholder="Apellido paterno del rector" required><br>
									<input type="text" id="apellido_materno_rector" name="apellido_materno_rector" class="form-control" value="" placeholder="Apellido materno del rector" required>
								</div>
								...
								<div class="form-group col-sm-12 col-md-12">
									...
									<input type="text" id="nombre" name="nombre" class="form-control" value="" placeholder="Nombre del director"><br>
									<input type="text" id="apellido_paterno" name="apellido_paterno" class="form-control" value="" placeholder="Apellido paterno del director"><br>
									<input type="text" id="apellido_materno" name="apellido_materno" class="form-control" value="" placeholder="Apellido materno del director">
								</div>

								<div class="col-sm-12 col-md-12">
									<input type="hidden" id="id" value="<?=$_GET["id"]?>">
									<input type="hidden" id="webService" name="webService" value="actualizarInformacion" />
