...
$pdf->SetTextColor( 0, 0, 0 );
$pdf->SetFont( "Arial", "B", 9 );
$pdf->Cell( 0, 5, utf8_decode("5. INFRAESTRUCTURA PARA EL PROGRAMA"), 1, 1, "C", true );
$pdf->SetFillColor( 191, 191, 191);
$pdf->Cell( 0, 5, utf8_decode("ESPACIOS Y EQUIPAMIENTO"), 1, 1, "C", true );

$headersI = ["instalacion"=>"INSTALACIONES", "capacidad"=>"CAPACIDAD PROMEDIO (No. ALUMNOS)",
            "metros"=>"METROS", "recursos"=>"RECURSOS MATERIALES",
              "ubicacion"=>"UBICACIÓN", "asignaturas"=>"ASIGNATURAS QUE ATIENDE"];
...
$lengthI = ["asignaturas"=>15,"instalacion"=>19,"capacidad"=>20,"metros"=>15,"recursos"=>39,"ubicacion"=>15];
  ...
  $pdf->SetX(161);
  $pdf->MultiCell( 35, 6, utf8_decode($headersI["asignaturas"]), 1,1, "C", true );
...
$pdf->Ln( 5 );
  ...
  $pdf->SetFont( "Arial", "B", 9 );
  $pdf->MultiCell( 0, 5, utf8_decode("6.  RELACIÓN DE INSTITUCIONES DE SALUD ALEDAÑAS, SERVICIOS DE AMBULANCIA U OTROS SERVICIOS DE EMERGENCIA A LOS CUALES RECURRIRÁ LA INSTITUCIÓN EN CASO DE ALGUNA CONTINGENCIA "), 1, "C", true );
  $pdf->SetFillColor( 191, 191, 191);
