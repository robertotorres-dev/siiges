...
$pdf->SetFont("Arial", "", 9);
$pdf->MultiCell(0, 5, utf8_decode($pdf->programa["perfil_ingreso_conocimientos"]), 1, "J");
if ($pdf->checkNewPage()) {
  $pdf->Ln(15);
}
$pdf->SetFont("Arial", "B", 9);
...
$pdf->SetFont("Arial", "", 9);
$pdf->MultiCell(0, 5, utf8_decode($pdf->programa["perfil_ingreso_habilidades"]), 1, "J");
if ($pdf->checkNewPage()) {
  $pdf->Ln(15);
}
$pdf->SetFont("Arial", "B", 9);
...
$pdf->SetFont("Arial", "", 9);
$pdf->MultiCell(0, 5, utf8_decode($pdf->programa["perfil_ingreso_actitudes"]), 1, "J");
if ($pdf->checkNewPage()) {
  $pdf->Ln(15);
}
$pdf->Ln(5);
...
$pdf->Cell(0, 5, utf8_decode("Conocimientos:"), 1, 1, "L", true);
$pdf->SetFont("Arial", "", 9);
$pdf->MultiCell(0, 5, utf8_decode($pdf->programa["perfil_egreso_conocimientos"]), 1, "J");
if ($pdf->checkNewPage()) {
  $pdf->Ln(15);
}
$pdf->SetFont("Arial", "B", 9);
$pdf->Cell(0, 5, utf8_decode("Habilidades:"), 1, 1, "L", true);
$pdf->SetFont("Arial", "", 9);
$pdf->MultiCell(0, 5, utf8_decode($pdf->programa["perfil_egreso_habilidades"]), 1, "J");
if ($pdf->checkNewPage()) {
  $pdf->Ln(15);
}
$pdf->SetFont("Arial", "B", 9);
$pdf->Cell(0, 5, utf8_decode("Actitudes:"), 1, 1, "L", true);
$pdf->SetFont("Arial", "", 9);
$pdf->MultiCell(0, 5, utf8_decode($pdf->programa["perfil_egreso_actitudes"]), 1, "J");
if ($pdf->checkNewPage()) {
  $pdf->Ln(15);
}
$pdf->Ln(5);
