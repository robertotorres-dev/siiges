...
class PDF extends PDF_MC_Table
{
  ...
  function getData($id = null)
  {
    ...
    foreach ($this->diligencias as $this->diligencia) {
      ...
      array_push($this->nombresDiligencias, [
        "nombre" => $this->usuarioD["nombre"] . " " . $this->usuarioD["apellido_paterno"] . " " . $this->usuarioD["apellido_materno"],
  ...
  function getDataPlantel($id = null)
  {
    ...
    foreach ($this->plantelSeguridadSistemas as $key => $plantelSeguridad) {
      ...
      array_push($this->seguridadSistemas, [
        "sistema" => $this->seguridadSistema["descripcion"],
    ...
    foreach ($this->plantelHigienes as $key => $plantelHigiene) {
      ...
      array_push($this->higienes, [
        "higiene" => $this->higiene["descripcion"],
